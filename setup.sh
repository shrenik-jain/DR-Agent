...
if [ -z "$ANTHROPIC_API_KEY" ]; then
    ...
    if [ ! -z "$api_key" ]; then
        ...
        echo "  You'll need to set ANTHROPIC_API_KEY before running the agent"
...
if [ ! -z "$ANTHROPIC_API_KEY" ]; then
    python3 -c "
from dr_agent import fetch_sdge_prices, fetch_caiso_carbon
...
echo "  2. Run evaluation: python3 evaluation.py"
echo "  3. Interactive:    jupyter notebook dragent_interactive.ipynb"
echo ""
